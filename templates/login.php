	...
	if(empty($err)) {
		...
		if($row['email']) {
				...
				if ($realhash == $tryhash) {
					...
					$err['login'] = "Username or Password is incorrect.";
		}
		else
			$err['login'] = "User is not registered";
...
<div class="modal fade popup hide" id="myModal">
        ...
        <div class="signin-box">
            ...
            <div class="input password"><input name="password" class="input-xlarge input-box" id="input04" type="password" maxlength="20" pattern="^.{5,20}$"  required/></div>           <div style="color:#e11; font-size:18px"><?php echo $err['login'];?> </div> <div class="clearfix"></div>
            <div class="submit">
...
<section class="extraMarTop"></section>
</body>
</html>
