...
<div class="modal fade popup hide" id="myModal">
        ...
        <div class="forgot-pass">
            <a href="templates/forgot_password.php" id="forgot_password_id">Forgot password</a>                </div>
        </div>
            </div>
<!--    <center>--><!--</center>-->
    <!-- form left end here -->
...
<header class="navbar-fixed-top extra">
    <div class="container">
        <div class="row">
            <div class="pull-left" style="padding-left:139px;>                
                <div class="span3 width158">
                    ...
                    <div class="span3 width178">
                        ...
                        <form action="" class="form-search"><input class="search-query" placeholder="Search" title="Search" type="text" onKeyUp="showResult(this.value)"/> 
